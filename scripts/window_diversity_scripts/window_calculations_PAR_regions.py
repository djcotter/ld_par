...
# These coordinates 
window_coordinates = [["PAR1", 60001, 2699520],["nonPAR1", 2699520, 88193855],["XTR", 88193855, 93193855],["nonPAR2", 93193855, 154931044],["PAR2", 154931044, 155260560]]
...
formatted_data = [['PAR1', data[0][1], data[0][2], float(data[0][3]/data[0][4]), data[0][4]],['nonPAR', data[1][1], data[3][2], nonPAR_diversity, nonPAR_called],['XTR', data[2][1], data[2][2], float(data[2][3]/data[2][4]), data[2][4]],['PAR2', data[4][1], data[4][2], float(data[4][3]/data[4][4]), data[4][4]]]
...
with open(output_file, 'wb') as csvfile:
	...
	writer.writerow("")
	writer.writerow(["*The nonPAR region spans the XTR but it excludes all data points in the XTR region"])
