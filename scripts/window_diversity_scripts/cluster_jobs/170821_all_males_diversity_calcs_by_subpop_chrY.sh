...
python ~/projects/1000_genomes/scripts/170721_Diversity_from_VCF_cyvcf_Output_pi_per_site_per_population_ignoreINDELs_Hohenlohe_check_for_haploid_sites.py --vcf ~/projects/1000_genomes/ALL.chrY.phase3_integrated_v2a.20130502.genotypes.vcf --population_lists ~/projects/1000_genomes/populations/subpops/${i}_males --chrom_inc Y
