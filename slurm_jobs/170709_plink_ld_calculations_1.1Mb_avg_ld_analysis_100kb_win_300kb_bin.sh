...
~/tools/plink2/bin/plink --vcf $MYTMPDIR/${i}_females_biallelic_variants_mac_filtered.recode.vcf --memory 4000 --out plink_files/${i}_females_biallelic_mac_filtered
