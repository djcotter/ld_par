YRI_females_avg_R2_100kb_windows_1Mb_ldBins <- read_delim("~/Desktop/YRI_females_avg_R2_100kb_windows_1Mb_ldBins.txt", 
...
ld_data_subset <- subset(ld_data, ld_data$position <= 7)
